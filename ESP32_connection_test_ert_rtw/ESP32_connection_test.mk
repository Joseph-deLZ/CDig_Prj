###########################################################################
## Makefile generated for component 'ESP32_connection_test'. 
## 
## Makefile     : ESP32_connection_test.mk
## Generated on : Wed May 13 12:55:19 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ESP32_connection_test.elf
...
SLIB_PATH                 = C:/Users/jhdel/DOCUME~1/MATLAB/R2026a/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ESP32_connection_test.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/ESP32_connection_test_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32 -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/variants/esp32 -I$(ARDUINO_ESP32_ROOT)/tools/esptool_py -I$(ARDUINO_ESP32_ROOT)/tools/mkspiffs -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/scheduler/include -I$(MATLAB_ROOT)/toolbox/target/shared/freertos/include -I$(START_DIR)/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -DARDUINO_SERIAL_RECEIVE_BUFFER_SIZE=256 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_TX_PIN_SERIAL0_=1 -D_RTT_RX_PIN_SERIAL0_=3 -D_RTT_TX_PIN_SERIAL1_=33 -D_RTT_RX_PIN_SERIAL1_=32 -D_RTT_TX_PIN_SERIAL2_=17 -D_RTT_RX_PIN_SERIAL2_=16 -DSERIAL_MULTIPURPOSE_0 -DSERIAL_MULTIPURPOSE_1 -DSERIAL_MULTIPURPOSE_2 -D_RTT_ANALOG_REF_=0 -DMW_NUM_PINS=25 -D_RTT_PWM_BLOCKS_ -D_RTT_PWM_CUSTOM_FREQUENCY_ -DARDUINO_DEFAULT_PWM_FREQUENCY=1000 -D_ONBOARD_EEPROM_SIZE_=0
...
DEFINES_STANDARD = -DMODEL=ESP32_connection_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_PWMDriver.c C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp $(START_DIR)/ESP32_connection_test_ert_rtw/ESP32_connection_test.c $(START_DIR)/ESP32_connection_test_ert_rtw/ESP32_connection_test_data.c $(START_DIR)/ESP32_connection_test_ert_rtw/rtGetInf.c $(START_DIR)/ESP32_connection_test_ert_rtw/rtGetNaN.c $(START_DIR)/ESP32_connection_test_ert_rtw/rt_nonfinite.c C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp "$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32/IPAddress.cpp" "$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32/Print.cpp" $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_freertos_init.c $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_thread.c $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_timer.c $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_semaphore.c

MAIN_SRC = $(START_DIR)/ESP32_connection_test_ert_rtw/ert_main.c
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o MW_AnalogInput.o ESP32_connection_test.o ESP32_connection_test_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
postbuild : $(PRODUCT)
	...
	echo $(call FORMAT_FOR_ECHO,### Invoking postbuild tool Partition Generator ...)
	$(GENPART) $(GENPARTFLAGS_HEX)
	echo $(call FORMAT_FOR_ECHO,### Done invoking postbuild tool.)
	echo $(call FORMAT_FOR_ECHO,### Invoking postbuild tool Create Bootloader Image ...)
	$(ESPTOOL) $(DEF)
	echo $(call FORMAT_FOR_ECHO,### Done invoking postbuild tool.)
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.S.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ESP32_connection_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/ESP32_connection_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ESP32_connection_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
MW_PWM.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_PWMDriver.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_PWMDriver.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ArduinoPinHandleMap.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_AnalogInput.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ESP32_connection_test_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_connection_test.o : $(START_DIR)/ESP32_connection_test_ert_rtw/ESP32_connection_test.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ESP32_connection_test_data.o : $(START_DIR)/ESP32_connection_test_ert_rtw/ESP32_connection_test_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/ESP32_connection_test_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/ESP32_connection_test_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/ESP32_connection_test_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_ArduinoHWInit.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinotarget/src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : C:/ProgramData/MATLAB/SupportPackages/R2026a/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mw_freertos_init.o : $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_freertos_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_thread.o : $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_thread.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_timer.o : $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_timer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_semaphore.o : $(MATLAB_ROOT)/toolbox/target/shared/freertos/src/mw_semaphore.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
info : 
	...
	echo $(call FORMAT_FOR_ECHO,### ESPTOOLFLAGS_BIN = $(ESPTOOLFLAGS_BIN))
	echo $(call FORMAT_FOR_ECHO,### GENPARTFLAGS_HEX = $(GENPARTFLAGS_HEX))
	echo $(call FORMAT_FOR_ECHO,### DEF = $(DEF))
